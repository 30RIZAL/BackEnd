...
const findRowById = async (req, res) => {
  const result = await req.context.models.cart_line_items.findByPk(req.params.id);
  return res.send(result);
};
...
//# sourceMappingURL=ClitCtrl.js.map